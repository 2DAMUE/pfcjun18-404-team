...
public class CreateMarcadorPerdida extends AppCompatActivity {

    private SectionsPagerAdapter mSectionsPagerAdapter;
    private ViewPager mViewPager;
    private TextView v_text_left, v_text_right;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_create_marcador_perdida, menu);
        return true;
    }
